<template>
  ...
  <div class="container col-md-8 corTabela">
    ...
    <div class="nome col">
      ...
      <input type="text" :disabled="form === 'excluir' ? true : false" class="form-control" v-model="grupoMuscular.nome"
        v-if="form === undefined">
      <input type="text" :disabled="form === 'editar' ? true : false" class="form-control" v-model="grupoMuscular.nome"
        v-if="form === 'editar'">
    </div>
    ...
    <div class="col d-flex align-items-center justify-content-center">
      ...
      <button type="button" v-if="form === undefined" class="btn btn-success mt-2 mb-2" @click="onClickCadastrar()">
        Cadastrar</button>
      <button type="button" v-if="form === 'editar'" class="btn btn-warning mt-2 mb-2" @click="onClickEditar()">
        Editar</button>
      <button type="button" v-if="form === 'excluir'" class="btn btn-danger mt-2 mb-2" @click="onClickExcluir()">
        Excluir</button>
    </div>
  </div>
</template>
