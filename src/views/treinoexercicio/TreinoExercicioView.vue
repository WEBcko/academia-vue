  ...
  <div class="container">
    ...
    <thead>
      ...
      <tbody class="table-group-divider">
        ...
        <tr v-for="item in treinoExercicioList" :key="item.id" class="col-md-12">
          ...
          <th class="col-md-6 text-start">{{ item.idTreino.codigOrdem}}</th>
          <th class="col-md-1"> {{ item.idExercicios.nome }}</th>
